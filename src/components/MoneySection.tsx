    ...
    <section className="py-12 md:py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center">
          ...
          <button className="cta-button px-8 py-4 md:px-12 md:py-5 rounded-lg font-bold text-lg md:text-xl uppercase tracking-wide flex items-center gap-3 mx-auto mb-8">
